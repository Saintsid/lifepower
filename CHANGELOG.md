...
### ✨ Добавлено
- **Главная и страница услуг:** Добавлены карточки «Онкосопровождение» и «Интегративная медицина», расширен список предложений до восьми услуг.

### 🔄 Изменено
- **Десктопные стили:** Сетка `.services-grid` теперь отображает по три карточки в ряд для единообразного вида на широких экранах.
