...
### 📝 Документация
- Добавлен файл `TELEGRAM_SETUP.md` с подробной инструкцией по настройке Telegram уведомлений
- Добавлен шаблон `env.template` для быстрой настройки переменных окружения
